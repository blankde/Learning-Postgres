...
DATA(insert OID = 403 (  btree	5 1 t f t t t t t f t t 0 btinsert btbeginscan btgettuple - btrescan btendscan btmarkpos btrestrpos btbuild btbuildempty btbulkdelete btvacuumcleanup btcostestimate btoptions ));
...
DATA(insert OID = 12589 (  mltree	5 1 t f t t t t t f t t 0 mlinsert mlbeginscan mlgettuple - mlrescan mlendscan - - mlbuild - - - mlcostestimate mloptions ));
DESCR("ml index access method");
#define MLTREE_AM_OID 12589
