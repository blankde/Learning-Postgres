...
DESCR("btree(internal)");
DATA(insert OID = 12590 (  mlbuild		   PGNSP PGUID 12 1 0 0 f f f t f v 3 0 2281 "2281 2281 2281" _null_ _null_ _null_ _null_ mlbuild _null_ _null_ _null_ ));
DESCR("mltree(internal)");
DATA(insert OID = 12591 (  mloptions		   PGNSP PGUID 12 1 0 0 f f f t f s 2 0 17 "1009 16" _null_ _null_ _null_ _null_  mloptions _null_ _null_ _null_ ));
DESCR("mltree(internal)");
DATA(insert OID = 12592 (  mlcostestimate   PGNSP PGUID 12 1 0 0 f f f t f v 9 0 2278 "2281 2281 2281 2281 2281 2281 2281 2281 2281" _null_ _null_ _null_ _null_ mlcostestimate _null_ _null_ _null_ ));
DESCR("mltree(internal)");
//mlbeginscan mlgettuple - mlrescan mlendscan
DATA(insert OID = 12593 (  mlbeginscan	   PGNSP PGUID 12 1 0 0 f f f t f v 3 0 2281 "2281 2281 2281" _null_ _null_ _null_ _null_	mlbeginscan _null_ _null_ _null_ ));
DESCR("btree(internal)");
DATA(insert OID = 12594 (  mlrescan		   PGNSP PGUID 12 1 0 0 f f f t f v 5 0 2278 "2281 2281 2281 2281 2281" _null_ _null_ _null_ _null_ mlrescan _null_ _null_ _null_ ));
DESCR("btree(internal)");
DATA(insert OID = 12595 (  mlendscan		   PGNSP PGUID 12 1 0 0 f f f t f v 1 0 2278 "2281" _null_ _null_ _null_ _null_ mlendscan _null_ _null_ _null_ ));
DESCR("btree(internal)");
DATA(insert OID = 12596 (  mlgettuple		   PGNSP PGUID 12 1 0 0 f f f t f v 2 0 16 "2281 2281" _null_ _null_ _null_ _null_	mlgettuple _null_ _null_ _null_ ));
DESCR("btree(internal)");
DATA(insert OID = 12597 (  mlinsert		   PGNSP PGUID 12 1 0 0 f f f t f v 6 0 16 "2281 2281 2281 2281 2281 2281" _null_ _null_ _null_ _null_	mlinsert _null_ _null_ _null_ ));
DESCR("btree(internal)");
...
DESCR("less-equal-greater");
DATA(insert OID = 16388 (  mlint4cmp		   PGNSP PGUID 12 1 0 0 f f f t f i 2 0 23 "23 23" _null_ _null_ _null_ _null_ mlint4cmp _null_ _null_ _null_ ));
DESCR("less-equal-greater");
